...
namespace XnaFlyby.Game.Entities
{
    ...
    public class Ocean : GridStripBase
    {
            ...
            : base(device, new Vector3(-2560.0f, -2560.0f, 0.0f), 40.0f, 144, 144)
        {
            ...
            this.Effect.Parameters["ViewportWidth"].SetValue(this.reflectionTarget.Width);   //device.Viewport.Width);
            this.Effect.Parameters["ViewportHeight"].SetValue(this.reflectionTarget.Height);  //device.Viewport.Height);
